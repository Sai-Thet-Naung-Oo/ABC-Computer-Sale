...
MainDatasetTableAdapters.ProductTableAdapter();
    ...
    protected void DisplayProduct()
    {
        ...
        Session["SesstionDtDisplay"] = DtDisplay;
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        else if (Convert.ToInt32(txtPrice.Text) < 1000 || Convert.ToInt32(txtPrice.Text) >
       10000000)
        {
            lblError2.Text = "Price Should Be Between 10,000 And 10,000,000";
            txtPrice.Focus();
            MultiView1.ActiveViewIndex = 1;
        }
        ...
        else
        {
           ...
           ddlCategoryName.SelectedItem.ToString());
            if (Dt.Rows.Count > 0)
            {
            ...
            {
                ProductTbl.Product_Insert(Convert.ToInt32(ddlCategoryName.SelectedValue),
               txtProductName.Text, Convert.ToInt32(txtPrice.Text.ToString()),
               Convert.ToInt32(txtQuantity.Text.ToString()));
                ...
                int ProID =
               Convert.ToInt32(ProductTbl.Product_Select_By_MaxProID().Rows[0][1]);
            ...
            else if (btnSave.Text == "Update")
            {
                ...
                ProductTbl.Product_Update(Convert.ToInt32(txtProductID.Text),
               Convert.ToInt32(ddlCategoryName.SelectedValue), txtProductName.Text,
